...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/wangshuange/catkin_ws/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /home/wangshuange/catkin_ws/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/wangshuange/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'wangshuange <wangshuange@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wangshuange/catkin_ws/src/beginner_tutorials/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/wangshuange/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
